...
function get_inputs()
{
	...
	int_inputs = ['stem_height', 'stem_thickness', 'toe_length', 'heel_length', 'base_thickness', 'shear_key_height', 'shear_key_thickness', 'back_steps', 'back_step_run', 'back_step_depth', 'back_angle', 'front_steps', 'front_step_run', 'front_step_depth', 'front_angle', 'water_inside', 'water_outside', 'water_under', 'surcharge'];
	...
	if (i.water_outside < i.base_thickness)
	{
	...
	if (i.water_inside < i.base_thickness)
	{
